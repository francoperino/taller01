...
public class BibliotecaABB implements Biblioteca {
	...
	private void ordenarPorPrecio() {
		...
		//TODO Completar
		ArbolBinarioBusqueda ordenPrecio=new ArbolBinarioBusqueda(comparaPrecio);
		List<MaterialCapacitacion> lista=materiales.inOrden();
		for(int i=0;i<lista.size();i++) {
			ordenPrecio.add(lista.get(i));
		}
		this.materiales=ordenPrecio;
	...
	private void ordenarPorTitulo() {
		...
		//TODO Completar
		ArbolBinarioBusqueda ordenTitulo=new ArbolBinarioBusqueda(comparaTitulo);
		List<MaterialCapacitacion> lista=materiales.inOrden();
		for(int i=0;i<lista.size();i++) {
			ordenTitulo.add(lista.get(i));
		}
		this.materiales=ordenTitulo;
	}
